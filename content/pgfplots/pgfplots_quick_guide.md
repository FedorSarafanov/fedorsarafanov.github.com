...
* 5. [Построение графика](#part5)
	...
	* 5.3. [Прямоугольники ошибок](#part53)
		* [5.3.1. Постоянная абсолютная или относитетельная погрешность](#part531)
		* [5.3.2. Абсолютная или относитетельная погрешность из файла](#part532)
...
### 3.1. Оси и их подписи. Загаловок графика. <a name="part31"></a>
...
\end{tikzpicture}
```
Обратите внимание на то, что у нас появился параметр `title`, задающий загаловок графику. Как правило, при использовании пакета standalone, это не нужно - загаловок графика задается командой caption в окружении figure.
...
### 5.3.1. Постоянная абсолютная или относитетельная погрешность <a name="part531"></a>
...
### 5.3.2. Абсолютная или относитетельная погрешность из файла <a name="part532"></a>
