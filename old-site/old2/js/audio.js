$(function () {
    ...
    var canva2 = document.getElementById("equ2");

    ww = canva.width;
    hh = $(window).height()/3; 
    point = canva.getContext('2d');   
    point2 = canva2.getContext('2d');     
    point2.fillStyle = "#fa8072";//"#26A9AE";
    point2.strokeStyle = "orange";
    point.fillStyle = "#fa8072";//"#26A9AE";
    ...
    function update() {
        ...
        for (var i = 0; i < analyser.frequencyBinCount; i++) {
            ...
            point2.clearRect(9*i, 0, 7, hh); 
            point2.fillRect(9*i, hh-height, 7, height);
            progress()
        }        
    };
